...
// const collectHobbies = (...users) => users.map(({ hobbies }) => hobbies);
const collectHobbies = (...users) => users.flatMap(({ hobbies }) => hobbies);

const allHobbies = collectHobbies(...users1, ...users2);
